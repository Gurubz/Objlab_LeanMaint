...
namespace Data.Config
{
	...
	public partial class GeographicCenterTypes : EntitiesManagerBase
	{
		...
		public GeographicCenterType[] ToArray()
		{
			List<GeographicCenterType> aRet = new List<GeographicCenterType>();
			foreach (GeographicCenterType oGeographicCenterType in this.m_aItems)
			{
				aRet.Add(oGeographicCenterType);
			}
			return (aRet.ToArray());
		}
		#endregion
		...
		public static DataSet LoadFast(string sWhere, string sOrderBy = "", SqlConnection oPrivateConnection = null)
		{
			...
			oSelect = new StringBuilder("SELECT * FROM [Config].[GeographicCenterTypes]");
		...
		public static void InsertOne(GeographicCenterType oGeographicCenterType, SqlConnection oPrivateConnection = null)
		{
			...
			oInsert = new StringBuilder("INSERT INTO [Config].[GeographicCenterTypes] ");
		...
		public static void UpdateOne(GeographicCenterType oGeographicCenterType, SqlConnection oPrivateConnection = null)
		{
			...
			oUpdate = new StringBuilder("UPDATE [Config].[GeographicCenterTypes] SET ");
