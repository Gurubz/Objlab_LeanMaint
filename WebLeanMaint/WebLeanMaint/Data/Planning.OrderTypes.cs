...
namespace Data.Planning
{
	...
	/// </remarks>
	public partial class OrderTypes : EntitiesManagerBase
	{
		...
		public static OrderType LoadOne(Int32 nID_OrderType, SqlConnection oPrivateConnection = null)
		{
			OrderType oOrderType = null;
			DataSet oDs = null;
			StringBuilder oSelect = null;
		...
		public static OrderType TryLoadOne(Int32 nID_OrderType, SqlConnection oPrivateConnection = null)
		{
			OrderType oOrderType = null;
		...
		public static void InsertOne(OrderType oOrderType, SqlConnection oPrivateConnection = null)
		{
		...
		public static void UpdateOne(OrderType oOrderType, SqlConnection oPrivateConnection = null)
		{
		...
		public static void DeleteOne(OrderType oOrderType, SqlConnection oPrivateConnection = null)
		{
			StringBuilder oDelete = null;
		...
		public static void DeleteOne(Int32 nID_OrderType, SqlConnection oPrivateConnection=null)
		{
			StringBuilder oDelete = null;

			oDelete = new StringBuilder("DELETE FROM [Planning].[OrderTypes]");

			oDelete.Append(UTI_Where4One(nID_OrderType));
